...
void dataset_add_cmd (struct dataset *ds, enum cmd cmd, int arg1, int arg2);
...
//void dataset_init_param(struct dataset *ds, struct param_info *param, const struct dict *condv);
...
extern struct dataset_results *analyse_dataset_ks(struct dataset *ds);

/* from "method-ml.c" */

extern struct dataset_results *analyse_dataset_ml(struct dataset *ds);

/* from "method-cs.c" */

extern struct dataset_results *analyse_dataset_cs(struct dataset *ds);
